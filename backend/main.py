...
TEMPLATES = [
    ...
    ("flat-lay", "平铺摆拍", "商品展示", "1:1", "俯拍陈列商品和少量相关道具，构图有秩序。"),
    ("detail-macro", "核心细节", "细节展示", "4:5", "特写呈现材质、结构、纹理和标志性细节。"),
    ("poster-banner", "卖点海报", "营销展示", "4:5", "突出商品，留出信息排版空间，适用于促销和传播。"),
    ("social-media", "社媒内容", "营销展示", "4:5", "为社交平台构建自然、有停留感的商品画面。"),
    ("ugc-style", "UGC 风格", "社媒内容", "4:5", "真实用户记录感、自然光和日常视角。"),
    ("model-showcase", "模特展示", "人物展示", "4:5", "由人物自然使用或穿着商品，突出比例和质感。"),
    ("before-after", "前后对比", "信息图", "1:1", "清楚、克制地呈现使用前后或方案对比。"),
    ("packaging", "包装设计", "商品展示", "1:1", "展示包装、开箱和品牌细节。"),
    ("infographic", "详情信息图", "信息图", "2:3", "以产品为核心组织卖点、参数和购买理由。"),
    ("creative-concept", "创意概念", "创意展示", "4:5", "使用独特但商业可用的创意概念呈现商品。"),
    ("size-spec", "尺寸规格", "信息图", "2:3", "清楚说明尺寸、结构、规格和适配信息。"),
    ("multi-product", "多品组合", "商品展示", "1:1", "有层次地展示商品组合、套装或不同规格。"),
    ("livestream", "直播间", "营销展示", "16:9", "构建可讲解、可带货的直播商品展示空间。"),
    ("try-on-virtual", "虚拟试用", "人物展示", "4:5", "展示商品在真人或使用场景中的自然效果。"),
    ("exploded-view", "爆炸图", "信息图", "1:1", "分解展示商品结构、零件和材料层次。"),
    ("ghost-mannequin", "隐形人台", "人物展示", "4:5", "用干净的人台展示服装版型和结构。"),
    ("multi-angle-grid", "多角度网格", "商品展示", "1:1", "以整齐网格清楚交代商品全貌和关键角度。"),
    ("magazine-editorial", "杂志编辑", "创意展示", "4:5", "高级编辑部摄影与有节制的品牌叙事。"),
    ("seasonal-campaign", "季节 Campaign", "营销展示", "4:5", "围绕季节或营销节点建立统一 Campaign。"),
    ("luxury-atmospherics", "轻奢氛围", "创意展示", "4:5", "低调、克制、有质感的高级商品氛围。"),
    ("device-mockup", "设备样机", "商品展示", "16:9", "展示数字产品或屏幕界面在真实设备中的效果。"),
    ("storefront", "店铺陈列", "营销展示", "16:9", "让商品成为店铺或陈列空间的视觉焦点。"),
    ("sports-campaign", "运动 Campaign", "营销展示", "4:5", "用有力量感的运动场景表达商品性能。"),
]
